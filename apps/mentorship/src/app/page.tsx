...
export default function MentorshipPage() {
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[600px] bg-grid-pattern opacity-40 pointer-events-none -z-10" />
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-yellow-400/5 blur-[120px] rounded-full pointer-events-none -z-10" />

      {/* HERO SECTION */}
      <section className="px-6 pt-6 pb-20 max-w-5xl mx-auto text-center">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-yellow-400/10 border border-yellow-400/20 text-yellow-400 text-xs font-bold tracking-wider uppercase mb-8">
        ...
        <div className="my-10 max-w-4xl mx-auto shadow-[0_0_50px_rgba(255,255,0,0.1)]">
      ...
      <section className="py-20 px-6 bg-[#0f0f13] border-y border-white/10 relative">
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="glass-panel p-8 rounded-2xl border-t-4 border-t-yellow-400 space-y-3">
      ...
      <section className="py-24 px-6 bg-[#09090c] border-t border-white/10">
      ...
      {/* WHO THIS IS NOT FOR */}
      <section className="py-20 px-6 bg-[#121217] border-y border-white/10">
      ...
      {/* BOTTOM CTA */}
      <section className="py-24 px-6 text-center bg-gradient-to-b from-[#0c0c0e] to-black relative">
