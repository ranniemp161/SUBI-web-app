...
export default function ApplicationFormPage() {
  ...
  return (
    <div className="relative overflow-hidden z-0 max-w-4xl mx-auto px-6 py-8">
      ...
      <FadeIn>
        <div className="text-center max-w-2xl mx-auto mb-10 relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-yellow-400/10 border border-yellow-400/20 text-yellow-400 text-xs font-bold tracking-wider uppercase mb-4 shadow-[0_0_20px_rgba(255,255,0,0.1)]">
      ...
      {submitted ? (
        <FadeIn>
          <div className="glass-panel p-10 md:p-14 rounded-3xl border border-yellow-400/40 text-center max-w-2xl mx-auto space-y-6 shadow-[0_0_50px_rgba(255,255,0,0.15)] relative z-10">
