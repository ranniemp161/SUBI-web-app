...
export default function EditorPage() {
  ...
  useEffect(() => {
    function handleKeyDown(e: KeyboardEvent) {
      ...
      // Space auto-repeats while held — ignore the repeats so resting on the
      // key doesn't rapid-fire play/pause. (Space used to double as the
      // timeline's pan arm; that's now the Hand tool on H, so Space is
      // play/pause and nothing else.)
