...
/**
 * Base URL of the Wallet app. Dev: wallet is pinned to 3001.
 *
 * B-Roll never processes a payment itself — the Wallet app is the sole
 * authority on Stripe billing. Every top-up is a deep link out to this URL and
 * back, which is why the URL is load-bearing rather than cosmetic: a wrong
 * value strands a user who has run out of credit mid-batch.
 */
