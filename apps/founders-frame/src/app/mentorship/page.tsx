      ...
      <FadeIn delay={0.2}>
        <section className="py-24 px-6 max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="glass-panel p-8 rounded-2xl border-t-4 border-t-brand space-y-3 hover:border-brand/80 transition-all">
              <div className="w-12 h-12 rounded-xl bg-brand/10 flex items-center justify-center text-brand mb-4">
                <Target className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-heading font-bold text-white">The Problem</h3>
            ...
            <div className="glass-panel p-8 rounded-2xl border-t-4 border-t-brand space-y-3 hover:border-brand/80 transition-all">
              ...
              <h3 className="text-xl font-heading font-bold text-white">The Gap</h3>
              <p className="text-gray-400 leading-relaxed">
        ...
        <section className="py-24 px-6 bg-[#09090c]/90 border-t border-white/10 relative z-10 backdrop-blur-md">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {pillars.map((pillar) => (
                <SpotlightCard key={pillar.num} className="p-8 flex flex-col justify-between">
                  <div>
                    <span className="text-3xl font-black text-brand tracking-wider font-mono block mb-4">
                      {pillar.num}
                    </span>
                  ...
                  <div className="mt-6 pt-4 border-t border-white/5 flex items-center text-xs font-semibold text-brand/80">
